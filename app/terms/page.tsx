      ...
      <section className="bg-hero-pattern pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 text-base">
            Please read these terms carefully before using the Veriq Property platform.
          </p>
        </div>
      </section>
              ...
              <div className="sticky top-24 rounded-2xl bg-veriq-surface p-5">
                ...
                <nav className="space-y-1">
                  {SECTIONS.map((section) => (
                    <a
                      key={section.id}
                      href={`#${section.id}`}
                      className="block rounded-lg px-3 py-2 text-sm text-navy-700 hover:bg-white hover:text-veriq-secondary transition-colors"
                    >
                      {section.title}
                    </a>
                  ))}
                ...
                <div className="mt-5 pt-5 border-t border-slate-200">
                  <p className="text-xs text-slate-500">
                    Effective Date: To be confirmed. Contact us for current effective dates.
                  </p>
                </div>
              </div>
            </aside>
            ...
            <div className="lg:col-span-3 space-y-12">
              {SECTIONS.map((section) => (
                <div key={section.id} id={section.id} className="scroll-mt-24">
                  <h2 className="font-display text-2xl font-bold text-navy-900 mb-6 pb-4 border-b border-slate-200">
                    {section.title}
                  </h2>
              ...
              <div className="rounded-2xl bg-veriq-surface p-6">
                <h3 className="font-display font-bold text-navy-900 mb-2">Contact Us</h3>
                <p className="text-sm text-veriq-muted">
                  For questions or disputes regarding these terms, contact our support team through our{" "}
