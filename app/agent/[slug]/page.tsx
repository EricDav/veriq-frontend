...
import {
  ...
  TrendingUp, Home, Users, Award, Briefcase, AlertCircle,
} from 'lucide-react';
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        try {
          const listRes = await propertiesApi.list({ page: 1, limit: 12 });
          const agentListings = listRes.data.filter(
            (p) => p.agentId === a.id && p.status === 'active',
          );
    ...
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h1 className="font-display text-2xl font-bold text-navy-900 mb-2">Agent Not Found</h1>
          <p className="text-slate-500 mb-6">This agent profile doesn&apos;t exist or may have been removed.</p>
